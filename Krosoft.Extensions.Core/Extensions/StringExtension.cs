...
public static class StringExtension
{
    ...
    public static string RemoveAllSpaces(this string text) => string.IsNullOrEmpty(text) ? text : Regex.Replace(text, @"\s+", string.Empty);
    ...
    public static string[] SplitAndClean(this string text, char splitString)
    {
        ...
        var split = from piece in text.Split(splitString)
