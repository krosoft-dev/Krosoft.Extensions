...
public class ReadOnlyDictionaryExtensionsTests
{
    ...
    public void GetValueOrDefaultReadOnlyDictionaryTest()
    {
        var adressesParStreetLine1 = new
            ReadOnlyDictionary<string, Address>(AddressFactory.GetAdresses().ToDictionary(x => x.StreetLine1));
    ...
    {
        IReadOnlyDictionary<string, Address> adressesParStreetLine1 = AddressFactory.GetAdresses().ToReadOnlyDictionary(x => x.StreetLine1);
